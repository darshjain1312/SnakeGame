...
pygame.display.set_caption('Snake Game - Slither game')
clock = pygame.time.Clock()
FPS = 6 #frame per sec it remove gliches
blockSize = 10
noPixel = 0
...
#first logic itscheck the key press and manage the snake
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if leftArrow:
                    ...
                    change_pixels_of_y = blockSize
                    change_pixels_of_x = noPixel
#second logic if you move out of the screen game over part
        ...
        gameDisplay.fill(white)
        AppleThickness = 10
# logic 3 creating the apple 
        print([int(randomAppleX),int(randomAppleY),AppleThickness,AppleThickness])
        #pygame.draw.circle(gameDisplay,red,[randomAppleX,randomAppleY],AppleThickness)
...
#logic 5 eating the apple and increating the size of apple 
